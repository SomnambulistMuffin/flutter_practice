...
/// this class is reuseable for the text theme elements for the apps theme
class TTextTheme{
  TTextTheme._();

/// custom Light text theme
  static TextTheme  lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.bold, color: Colors.black), // copywith function is to copy existing  text elements within the theme
    ...
    titleMedium: const TextStyle().copyWith(fontSize: 24.0,fontWeight: FontWeight.w500, color: Colors.black),
    titleSmall: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme  darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.bold, color: Colors.white), // copywith function is to copy existing  text elements within the theme
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.w600, color: Colors.white),
